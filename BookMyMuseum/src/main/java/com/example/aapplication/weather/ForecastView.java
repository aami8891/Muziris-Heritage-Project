...
public class ForecastView extends LinearLayout {
    ...
    private int[] weatherToGradient(Weather weather) {
        switch (weather) {
            ...
            case CHERAMAN:
                return colors(R.array.cheraman);
            default:
    ...
    private int weatherToIcon(Weather weather) {
        switch (weather) {
            case PERIODIC_CLOUDS:
                return R.drawable.kerala;
            case CLOUDY:
                return R.drawable.napier_museum_kerala;
            case MOSTLY_CLOUDY:
                return R.drawable.shakthan_thampuran_palace;
            case PARTLY_CLOUDY:
                return R.drawable.hill;
            case CLEAR:
                return R.drawable.krishnapuram;
            case CHERAMAN:
                return R.drawable.cheraman;
            default:
                throw new IllegalArgumentException();
        }
    }
