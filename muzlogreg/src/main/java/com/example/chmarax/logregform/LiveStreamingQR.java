 ...
 */
public class LiveStreamingQR extends Fragment {
    View v;
    ...
    LiveStreamingPlayer fragment1;
    FragmentManager fragmentManager;
    FragmentTransaction fragmentTransaction;
    public LiveStreamingQR() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         v = inflater.inflate(R.layout.fragment_live_streaming_q_r, container, false);
...
//                                        txtBarcodeValue.setText(intentData);
                                        fragment1 = new LiveStreamingPlayer();
